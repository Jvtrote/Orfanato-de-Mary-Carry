...
public class mesaCarne : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag(Vermelho))
        {
            ...
            Debug.Log(Vermelho + " correto na mesa " + gameObject.name + ". Total: " + pratosCorretosNaMesa);
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        {
            pratosCorretosNaMesa--;
            Debug.Log(Vermelho + " removido da mesa " + gameObject.name + ". Total: " + pratosCorretosNaMesa);
